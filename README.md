[README.md](https://github.com/user-attachments/files/31866944/README.md)
<div align="center">
...
Grado en Ingeniería de Sistemas Aeroespaciales · EETAC — Universitat Politècnica de Catalunya
...
Antes de entrar en el código, este vídeo muestra la aplicación final funcionando
de principio a fin, con los cuatro vehículos: SITL, el Hexsoon EDU-450, el DJI
Tello y un dispositivo Android.

<div align="center">
<a href="https://youtu.be/5l0LcPJWVQY">
  <img src="https://img.youtube.com/vi/5l0LcPJWVQY/hqdefault.jpg" width="400" alt="Demostración completa de EZDrone">
</a>
...
Los seis vídeos siguientes recorren la implementación en detalle, de la
arquitectura general al bucle de control autónomo. El código está comentado,
pero si vas a partir de este trabajo, verlos ahorra bastante tiempo de lectura.

<div align="center">
<table>
<tr>
<td align="center" width="270">
  <a href="https://youtu.be/vMNlfsRgbHk"><img src="https://img.youtube.com/vi/vMNlfsRgbHk/hqdefault.jpg" width="250" alt="Arquitectura y comunicaciones de EZDrone"></a><br>
  <sub><b>1 · Arquitectura y comunicaciones</b><br>El reparto entre MQTT y WebRTC</sub>
</td>
<td align="center" width="270">
  <a href="https://youtu.be/K5B17Mp4ObU"><img src="https://img.youtube.com/vi/K5B17Mp4ObU/hqdefault.jpg" width="250" alt="El núcleo del frontend"></a><br>
  <sub><b>2A · El núcleo del frontend</b><br><code>DronProvider</code>, MQTT y WebRTC</sub>
</td>
<td align="center" width="270">
  <a href="https://youtu.be/G7AsF8uxAZc"><img src="https://img.youtube.com/vi/G7AsF8uxAZc/hqdefault.jpg" width="250" alt="Las siete pantallas"></a><br>
  <sub><b>2B · Las siete pantallas</b><br>Recorrido por la interfaz</sub>
</td>
</tr>
<tr>
<td align="center" width="270">
  <a href="https://youtu.be/lxeTtF5uGkg"><img src="https://img.youtube.com/vi/lxeTtF5uGkg/hqdefault.jpg" width="250" alt="La estación de tierra"></a><br>
  <sub><b>3 · La estación de tierra</b><br>Traducción de comandos y vídeo</sub>
</td>
<td align="center" width="270">
  <a href="https://youtu.be/ncDoQYVR7XY"><img src="https://img.youtube.com/vi/ncDoQYVR7XY/hqdefault.jpg" width="250" alt="Las piezas del seguimiento autónomo"></a><br>
  <sub><b>4A · Las piezas del seguimiento</b><br>Detección de pose y PID</sub>
</td>
<td align="center" width="270">
  <a href="https://youtu.be/rIV5hgvKS7o"><img src="https://img.youtube.com/vi/rIV5hgvKS7o/hqdefault.jpg" width="250" alt="El bucle de control, la órbita y la panorámica"></a><br>
...
<td align="center" width="320">
  <a href="https://youtu.be/GlaCXkNl5lc"><img src="https://img.youtube.com/vi/GlaCXkNl5lc/hqdefault.jpg" width="300" alt="Código de la arquitectura software"></a><br>
  <sub><b>Código de la primera arquitectura</b><br>Frontend, backend Dart y estación de tierra</sub>
</td>
<td align="center" width="320">
  <a href="https://youtu.be/9Cc5S4YHzWw"><img src="https://img.youtube.com/vi/9Cc5S4YHzWw/hqdefault.jpg" width="300" alt="Demostración de la arquitectura software"></a><br>
...
|:---:|---|---|
| <a href="https://youtu.be/MmS4x3k0xWc"><img src="https://img.youtube.com/vi/MmS4x3k0xWc/hqdefault.jpg" width="200" alt="Catálogo de widgets"></a> | [`main_widgets_demo`](demostraciones/main_widgets_demo) | Catálogo interactivo de los diez widgets de la interfaz, con sus estados y las trampas de implementación de cada uno |
| <a href="https://youtu.be/2uODMl3SNz4"><img src="https://img.youtube.com/vi/2uODMl3SNz4/hqdefault.jpg" width="200" alt="Joystick"></a> | [`joysticks`](demostraciones/joysticks) | Dos joysticks estilo mando RC y la conversión a señal PWM |
| <a href="https://youtu.be/ksLqzfz2euc"><img src="https://img.youtube.com/vi/ksLqzfz2euc/hqdefault.jpg" width="200" alt="Control por voz"></a> | [`control_por_voz`](demostraciones/control_por_voz) | Reconocimiento de voz con palabra de activación y máquina de estados de escucha |
| <a href="https://youtu.be/NntmhBeBD48"><img src="https://img.youtube.com/vi/NntmhBeBD48/hqdefault.jpg" width="200" alt="Control por sensores del móvil"></a> | [`datos_inerciales`](demostraciones/datos_inerciales) | Lectura de la unidad inercial desde el navegador mediante puente JavaScript |
| <a href="https://youtu.be/eMVm8PYw4xQ"><img src="https://img.youtube.com/vi/eMVm8PYw4xQ/hqdefault.jpg" width="200" alt="Geolocalización"></a> | [`ubicacion_mapa`](demostraciones/ubicacion_mapa) | Posición del operador en tiempo real sobre cartografía abierta |
| <a href="https://youtu.be/wrdD5_J_Hk4"><img src="https://img.youtube.com/vi/wrdD5_J_Hk4/hqdefault.jpg" width="200" alt="Vídeo y detección con YOLO"></a> | [`video_webrtc`](demostraciones/video_webrtc) | Emisor Python con WebRTC y detección YOLO, y cliente Flutter |
| <a href="https://youtu.be/Nw7tMJLrk4Y"><img src="https://img.youtube.com/vi/Nw7tMJLrk4Y/hqdefault.jpg" width="200" alt="Plan de vuelo"></a> | [`flight_plan_demo`](demostraciones/flight_plan_demo) | Planificación de misiones, acciones por waypoint y exportación a formato Mission Planner |
| <a href="https://youtu.be/8pK-5dMdbGM"><img src="https://img.youtube.com/vi/8pK-5dMdbGM/hqdefault.jpg" width="200" alt="Registro de vuelos"></a> | [`flight_log_demo`](demostraciones/flight_log_demo) | Historial de vuelos, reproducción temporal de la telemetría y exportación a CSV |
...
- **La capa de comandos no está autenticada.** Se apoya en un broker público, y
  el sistema no verifica el origen de los mensajes. Es aceptable en un entorno
  docente controlado, pero es la primera barrera que habría que levantar antes de
  cualquier uso operativo.
- **El bloqueo de orientación de pantalla solo funciona en Android.**
- **El control por voz depende del motor del navegador**, cuyo soporte y calidad
  varían entre plataformas.
- **La arquitectura asume conectividad continua.** Una pérdida de cobertura
  interrumpe el enlace de comandos, y el sistema no tiene hoy más contingencia
  que los modos de fallo del propio autopiloto.
- **No cubre configuración ni mantenimiento del vehículo**: no calibra sensores
  ni ajusta parámetros del autopiloto. Cubre el ciclo de operación, no el de
  puesta a punto.
...
- **Broker propio con autenticación** y control de acceso por topic.
- **Operación con varios vehículos simultáneos**: el convenio de topics ya lo
  admite, pero el frontend asume hoy un único vehículo.
- **Soporte de PX4**: al hablar con el vehículo a través de MAVLink, los cambios
  quedarían acotados a la estación de tierra.
- **Trasladar los lazos autónomos al computador de a bordo**, para que el bucle
  de control deje de depender de la calidad del enlace de red.
- **Evaluación con usuarios** sin experiencia previa, que contraste la afirmación
  de que la interfaz reduce la barrera de entrada.
...
[Drone Engineering Ecosystem](https://github.com/dronsEETAC/DroneEngineeringEcosystemDEE)
de la EETAC, la plataforma docente de drones de la escuela.

La memoria completa del trabajo, con el detalle de las decisiones de diseño, su
justificación y los resultados de la validación, está en [`memoria/`](memoria/).

**Autor** · Dídac Bosch Garcias
**Titulación** · Grado en Ingeniería de Sistemas Aeroespaciales
**Centro** · EETAC — Universitat Politècnica de Catalunya
