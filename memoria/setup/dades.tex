...
\titulacio{Grau en Enginyeria de Sistemes Aeroespacials}
...
\titol{Estación de Control de Drones basada en Flutter Web}

%% Titol del document en anglès (Per l'apartat overview)
\titolE{Flutter Web-based Drone Control Station}

%% Titol del document en catala/castella (Per l'apartat resum)
\titolC{Estación de Control de Drones basada en Flutter Web}
